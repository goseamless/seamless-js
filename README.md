...
To enable extra targetings, you need to define the global variable called window.seamlessAppToken. The value for this variable is a string object which contains the token of the application that given by seamless ad operations team. Ad properties and options are defined in the window.seamlessAds global variable. The value for this variable is an array of objects and each object in the array has the definition for a single ad place.
...
<script type="text/javascript">
    window.seamlessAppToken = "APP_TOKEN";
    window.seamlessAds = [{
        adUnitId: 'AD_UNIT_ID',
...
- **enableDesktop** => default value is false. If set to true, seamless.js will be enabled in desktop browsers as well.
